...
#
# Usage:
#   replay-commits.sh <private-repo-dir> <public-repo-dir> <sync-config-json>
#
# Walks each new commit on the private repo's main branch since the last
# synced SHA, copies changed files into the public repo, and commits with
# the original author name, email, and date.  The committer identity stays
# as the bot so that "who pushed" is clear while "who wrote it" is accurate.
#
